...
module.exports = {
  ...
  "get-user-details": async (data) => {
    ...
    const query = `SELECT u.first_name, u.last_name, u.user_name, u.email, u.password, ut.user_type_name as user_role FROM ?? u JOIN ?? ut ON u.user_type = ut.id WHERE u.email = ? OR u.user_name = ?;`;
